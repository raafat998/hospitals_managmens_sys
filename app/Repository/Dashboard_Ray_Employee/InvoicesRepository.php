...
class InvoicesRepository implements InvoicesRepositoryInterface
{
   ...
   public function index()
   {
       ...
       return view('dashboard_RayEmployee.invoices.index',compact('invoices'));
   }

   public function create()
   {
       $invoices = Ray::where('case',1)->get();
       return view('dashboard_RayEmployee.invoices.completed',compact('invoices'));
   }
   public function edit($id)
   {
       $invoice = Ray::findorFail($id);
       return view('dashboard_RayEmployee.invoices.add_diagnosis',compact('invoice'));
   }
