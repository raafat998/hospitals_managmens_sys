...
class ReceiptRepository implements ReceiptRepositoryInterface
{
    ...
    public function create()
    {
        ...
        return view('Receipt.create',compact('Patients'));
    }
    ...
    public function edit($id)
    {
        ...
        $Patients = Patient::all();
        return view('Receipt.edit',compact('receipt_accounts','Patients'));
    }
    ...
    public function show($id)
    {
        ...
        $Patients = Patient::all();
        return view('Receipt.print',compact('receipt','Patients'));
    }
