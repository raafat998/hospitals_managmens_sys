...
<div id="scrolled-dropdown" class="p-5 absolute top-0 right-0 mt-4 mr-4">
    <div class="preview">
        <div class="flex justify-center">
            <div class="relative inline-block text-left">
                <div>
                    <button class="btn btn-primary" onclick="toggleDropdown()">
                        {{ app()->getLocale() == 'ar' ? 'اختر اللغة ' : 'select Language' }}                </button>
                    </button>
                </div>
                        ...
                        <li>
                            <a href="{{ LaravelLocalization::getLocalizedURL('ar') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="30" height="30" viewBox="0 0 256 256" xml:space="preserve">
                                    <defs></defs>
                                    <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
                                        <path d="M 2.571 30 l 84.859 0 C 81.254 12.534 64.611 0.015 45.034 0 l -0.068 0 C 25.389 0.015 8.745 12.534 2.571 30 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(29,29,27); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0)" stroke-linecap="round"/>
                                        <path d="M 87.429 60 L 2.571 60 C 8.75 77.476 25.408 90 45 90 S 81.25 77.476 87.429 60 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(0,153,0); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0)" stroke-linecap="round"/>
                                        ...
                                        <path d="M 14.275 12.136 C 5.495 20.348 0 32.029 0 45 c 0 12.918 5.452 24.556 14.17 32.763 L 70.818 44.94 L 14.275 12.136 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,0,0); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0)" stroke-linecap="round"/>
                                        <path d="M 12.107 51.338 l 1.033 -4.525 H 8.5 l 4.18 -2.014 l -2.893 -3.628 l 4.18 2.014 L 15 38.662 l 1.032 4.525 l 4.18 -2.014 L 17.32 44.8 l 4.18 2.014 h -4.64 l 1.032 4.525 L 15 47.707 L 12.107 51.338 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0)" stroke-linecap="round"/>
                                    </g>
                                </svg>
...
<script>
    ...
    window.addEventListener('click', function(event) {
        const dropdownButton = document.querySelector('.btn-primary');
        const dropdownMenu = document.getElementById('dropdownMenu');
