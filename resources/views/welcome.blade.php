...
@section('content')
  <!-- Main Slider -->
	<section class="main-slider">
		<div class="banner-carousel">
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide slide" style="background-image:url(https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg)">
				...
				<div class="swiper-slide slide" style="background-image:url(https://validthemes.net/site-template/healdi/assets/img/banner/1.jpg)">
					<div class="auto-container">
						<div class="content">
							<div class="title">Welcome our Medical Care Center</div>
							<h2>Take Care of Your Health</h2>
				...
				<div class="swiper-slide slide" style="background-image:url(https://validthemes.net/site-template/healdi/assets/img/banner/3.jpg)">
					<div class="auto-container">
						<div class="content">
							<div class="title">Welcome our Medical Care Center</div>
							<h2>Take Care of Your Health</h2>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="{{URL::asset('https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg')}}" alt=""/>
                            </div>
                        </div>
                    </div>
    ...
    <section class="department-section-three">
        <div class="image-layer" style="background-image:url(https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg)"></div>
        <div class="auto-container">
            <!-- Department Tabs-->
    ...
    <!-- Video Section -->
    <section class="video-section" style="background-image:url(https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg)">
        <div class="auto-container">
            <div class="content">
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column wow slideInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg" alt=""/>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Counter Section -->
    <section class="counter-section style-two" style="background-image: url(https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg)">
        <div class="auto-container">
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="blog-detail.html"><img src="https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <div class="content">
                                <ul class="post-info">
        ...
        <div class="outer-container">
            ...
            <div class="sponsors-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="https://validthemes.net/site-template/healdi/assets/img/banner/2.jpg" alt=""></a></figure>
                    </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const swiper = new Swiper('.banner-carousel', {
                loop: true, // لتكرار الشرائح بعد انتهاء العرض
                autoplay: {
                    delay: 6000, // التأخير بين الشرائح (بالثواني)
                    disableOnInteraction: false, // لاستمرار التشغيل التلقائي حتى عند التفاعل مع الشرائح
                },
                pagination: {
                    el: '.swiper-pagination',
                    type: 'progressbar', // استخدام شريط التقدم بدلاً من النقاط
                },
                navigation: {
                    nextEl: '.swiper-button-next',
                    prevEl: '.swiper-button-prev',
                },
                effect: 'slide', // يمكنك استخدام تأثيرات أخرى مثل 'slide' أو 'cube' أو 'flip'
            });
        });
    </script>
