...
<div class="gallery-container">
    ...
    <div class="gallery-container mt-3">
        <div class="form-group mb-4">
            <h5 class="intro-y text-lg font-medium  ">ملاحظات دكتور الأشعة</h5>
            <textarea readonly class="form-control mt-3" id="exampleFormControlTextarea1" rows="3">{{$rays->description_employee}}</textarea>
        </div>
    </div>
        ...
        <div class="intro-y col-span-12 overflow-x-auto lg:overflow-visible">
                ...
                <div class="gallery-grid" id="lightgallery">
                    @foreach($rays->images as $image)
                        <div class="btn-primary gallery-item" data-src="{{URL::asset('storage/properties/Rays/'.$image->filename)}}">
                            <a href="{{URL::asset('storage/properties/Rays/'.$image->filename)}}">
                                <img src="{{URL::asset('storage/properties/Rays/'.$image->filename)}}" alt="صورة الأشعة">
                            </a>
                        </div>
                    @endforeach
                </div>
