<!-- BEGIN: Modal Content -->
<div data-tw-backdrop="" aria-hidden="true" tabindex="-1" id="edit_lab_conversion{{$patient_Laboratorie->id}}" class="modal bg-black/60 w-screen h-screen fixed inset-0 flex items-center justify-center" style="display: none;">
    <div data-tw-merge class="relative bg-white rounded-md shadow-md dark:bg-darkmode-600 transition-transform duration-300" style="width: 800px; max-width: 90%; mx-4 my-8;"> <!-- عرض ثابت 800px -->
        ...
        <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
            <h2 class="mr-auto text-base font-medium"> التحويل الى قسم المختبر </h2>
        ...
        <form action="{{route('Laboratories.update',$patient_Laboratorie->id)}}" method="POST">
            ...
            <div class="p-5">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea id="medicine" name="description" rows="6" class="form-control w-full h-24 border rounded-md shadow-sm focus:ring-4 focus:ring-primary dark:bg-darkmode-800 dark:border-darkmode-400" required>{{$patient_Laboratorie->description}}</textarea>
                </div>
            </div>
            <!-- END: Modal Body -->
