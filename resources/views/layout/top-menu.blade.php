                    ...
                    <div class="notification-content__box dropdown-content">
                        ...
                        @foreach (array_slice($fakers, 0, 5) as $key => $faker)
                            <div class="cursor-pointer relative flex items-center {{ $key ? 'mt-5' : '' }}">
                                <div class="dropdown-toggle w-9 h-9 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                                    <img alt="Profile Image" src="{{ Auth::user()->profile_image? asset(Auth::user()->profile_image) : asset('build/assets/images/default-profile.png') }}">
                                </div>
